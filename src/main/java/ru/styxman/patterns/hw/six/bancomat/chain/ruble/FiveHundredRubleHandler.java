...
import ru.styxman.patterns.hw.six.bancomat.banknote.rub.FiveHundredRublesBanknote;
import ru.styxman.patterns.hw.six.bancomat.chain.AbstractBanknoteHandler;

/**
 * FiveHundredRubleHandler.
 */
public class FiveHundredRubleHandler extends AbstractBanknoteHandler {
    ...
    protected Banknote getBanknote() {
        return new FiveHundredRublesBanknote();
    }
}
