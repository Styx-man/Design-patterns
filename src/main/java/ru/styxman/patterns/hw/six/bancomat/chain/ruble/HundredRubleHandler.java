...
import ru.styxman.patterns.hw.six.bancomat.banknote.rub.HundredRublesBanknote;
import ru.styxman.patterns.hw.six.bancomat.chain.AbstractBanknoteHandler;

/**
 * HundredRubleHandler.
 */
public class HundredRubleHandler extends AbstractBanknoteHandler {
    ...
    protected Banknote getBanknote() {
        return new HundredRublesBanknote();
    }
}
